...
class DiscordEvents:
    ...
    def __init__(self, discord_token: str) -> None:
        ...
        self.auth_headers = {
            ...
            'User-Agent': f'DiscordBot (https://discord.com/developers/applications/1198073945518260354/bot) Python/3.9 aiohttp/3.8.1',
    ...
    async def delete_guild_events(self, guild_id: str) -> None:
        '''Deletes all guild events labelled with GAME DAY. TO DO'''
